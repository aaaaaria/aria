...
public class TrailMakingActivity extends Activity implements OnClickListener
{
    ...
    TrailMakingQuestion trailmakingQuestion;/////////////test
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.trail_making);
        InitView();
    }
    ...
    private void InitView()
    {
        ...
        trailmakingQuestion = (TrailMakingQuestion) ((mQuestionItemSet.GetQuestion()));
        if (trailmakingQuestion.num == 0)
        {
            TrailMakingView trail_making = (TrailMakingView) findViewById(R.id.trail_making);///////////
            trail_making.Init(trailmakingQuestion, helper);
            Button btn = (Button) findViewById(R.id.trail_makingGetNext);
        ...
        {
            TrailMakingViewBelance trail_making = (TrailMakingViewBelance) findViewById(R.id.trail_making2);///////////
            trail_making.Init(trailmakingQuestion, helper);
            Button btn = (Button) findViewById(R.id.trail_makingGetNext);
            btn.setOnClickListener(this);
            Button BtnFinal = (Button) findViewById(R.id.btnFINISH);
    ...
    public void onClick(View v)
    {
        ...
        {
            trailmakingQuestion.skip = true;
            for (int i = 0; i < trailmakingQuestion.skipQues.size(); ++i)
                mQuestionItemSet.questionItemSet.get(trailmakingQuestion.skipQues.get(i)).skip = true;
        } else
            trailmakingQuestion.skip = false;
        if (trailmakingQuestion.num == 0)
        {
            ((TrailMakingQuestion) (mQuestionItemSet.GetQuestion())).GetAnswer((TrailMakingView) findViewById(R.id.trail_making));
        } else if (trailmakingQuestion.num == 1)
        {
            ((TrailMakingQuestion) (mQuestionItemSet.GetQuestion())).GetAnswer2((TrailMakingViewBelance) findViewById(R.id.trail_making2));
        }
        switch (v.getId())
        {
            case R.id.trail_makingGetNext:
                ...
                intent.setClass(TrailMakingActivity.this, mQuestionItemSet.GetActivity());
            ...
            case R.id.btnFINISH:
                ...
                intent2.setClass(TrailMakingActivity.this, EndActivity.class);
            ...
            case R.id.btnBACK:
                ...
                intent3.setClass(TrailMakingActivity.this, Content2.class);
