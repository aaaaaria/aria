...
public class BostonNamingActivity extends Activity implements OnClickListener
{
    ...
    Boston_namingQuestion bostonQuestion;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.boston_naming);
        InitView();
    }
    ...
    private void InitView()
    {
        ...
        bostonQuestion = (Boston_namingQuestion) ((mQuestionItemSet.GetQuestion()));
        BostonNamingView bostons = (BostonNamingView) findViewById(R.id.bostonnaming);///////////
        bostons.Init(bostonQuestion, helper);
        Button btn = (Button) findViewById(R.id.bostonGetNext);
    ...
    public void onClick(View v)
    {
        ...
        {
            bostonQuestion.skip = true;
            for (int i = 0; i < bostonQuestion.skipQues.size(); ++i)
                mQuestionItemSet.questionItemSet.get(bostonQuestion.skipQues.get(i)).skip = true;
        } else
            bostonQuestion.skip = false;
        ((Boston_namingQuestion) (mQuestionItemSet.GetQuestion())).GetAnswer((BostonNamingView) findViewById(R.id.bostonnaming));
...
//                        Log.e("Upload file to server Exception", "Exception : " + e.getMessage(), e);
            ...
            case R.id.bostonGetNext:
                ...
                intent.setClass(BostonNamingActivity.this, mQuestionItemSet.GetActivity());
            ...
            case R.id.btnFINISH:
                ...
                intent2.setClass(BostonNamingActivity.this, EndActivity.class);
            ...
            case R.id.btnBACK:
                ...
                intent3.setClass(BostonNamingActivity.this, Content2.class);
