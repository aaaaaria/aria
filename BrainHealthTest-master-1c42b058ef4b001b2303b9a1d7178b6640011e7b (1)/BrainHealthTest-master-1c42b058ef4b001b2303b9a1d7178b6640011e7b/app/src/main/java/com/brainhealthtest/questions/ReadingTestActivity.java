...
public class ReadingTestActivity extends Activity implements OnClickListener
{
    ...
    ReadingTestQuestion readingtestQuestion;
    ...
    Handler handler = new Handler()
    {
        ...
        public void handleMessage(Message msg)
        {
            ...
            ((ReadingTestQuestion) (mQuestionItemSet.GetQuestion())).GetTempAnswer((ReadingTestView) findViewById(R.id.readingtestview));
    ...
    private void InitView()
    {
        ...
        readingtestQuestion = (ReadingTestQuestion) ((mQuestionItemSet.GetQuestion()));
        ReadingTestView readingtest = (ReadingTestView) findViewById(R.id.readingtestview);///////////
        readingtest.Init(readingtestQuestion, helper);
        Button btn = (Button) findViewById(R.id.readingGetNext);
        ...
        finalR = readingtestQuestion.record;
        task = new TimerTask()
        {
            @Override
            public void run()
    ...
    public void onClick(View v)
    {
        ...
        {
            readingtestQuestion.skip = true;
            for (int i = 0; i < readingtestQuestion.skipQues.size(); ++i)
                mQuestionItemSet.questionItemSet.get(readingtestQuestion.skipQues.get(i)).skip = true;
        } else
            readingtestQuestion.skip = false;

        ((ReadingTestQuestion) (mQuestionItemSet.GetQuestion())).GetAnswer((ReadingTestView) findViewById(R.id.readingtestview));
...
//                        Log.e("Upload file to server Exception", "Exception : " + e.getMessage(), e);
            ...
            case R.id.readingGetNext:
                ...
                intent.setClass(ReadingTestActivity.this, mQuestionItemSet.GetActivity());
            ...
            case R.id.btnFINISH:
                ...
                intent2.setClass(ReadingTestActivity.this, EndActivity.class);
            ...
            case R.id.btnBACK:
                ...
                intent3.setClass(ReadingTestActivity.this, Content2.class);
