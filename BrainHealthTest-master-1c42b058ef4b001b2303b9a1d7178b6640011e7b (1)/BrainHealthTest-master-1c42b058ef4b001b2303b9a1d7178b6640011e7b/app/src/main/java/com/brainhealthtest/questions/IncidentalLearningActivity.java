...
public class IncidentalLearningActivity extends Activity implements OnClickListener
{
    ...
    IncidentalLearningQuestion incidentallearningQuestion;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.incidental_learning);
        InitView();
    }
    ...
    private void InitView()
    {
        ...
        incidentallearningQuestion = (IncidentalLearningQuestion) ((mQuestionItemSet.GetQuestion()));

        if (incidentallearningQuestion.num == 0)
        {
            IncidentalLearningView incidental1 = (IncidentalLearningView) findViewById(R.id.incidental_learning1);////id.view///////
            incidental1.Init(incidentallearningQuestion, helper);

            Button btn = (Button) findViewById(R.id.incidental_learningGetNext);
        ...
        {
            IncidentalLearningViewB incidental2 = (IncidentalLearningViewB) findViewById(R.id.incidental_learning2);////id.view///////
            incidental2.Init(incidentallearningQuestion, helper);
            Button btn = (Button) findViewById(R.id.incidental_learningGetNext);
            btn.setOnClickListener(this);
            Button BtnFinal = (Button) findViewById(R.id.btnFINISH);
            BtnFinal.setOnClickListener(this);
    ...
    public void onClick(View v)
    {
        ...
        {
            incidentallearningQuestion.skip = true;
            for (int i = 0; i < incidentallearningQuestion.skipQues.size(); ++i)
                mQuestionItemSet.questionItemSet.get(incidentallearningQuestion.skipQues.get(i)).skip = true;
        }
        if (incidentallearningQuestion.num == 0)
        {
            ((IncidentalLearningQuestion) (mQuestionItemSet.GetQuestion())).GetAnswer((IncidentalLearningView) findViewById(R.id.incidental_learning1));
        }
        if (incidentallearningQuestion.num == 1)
        {
            ((IncidentalLearningQuestion) (mQuestionItemSet.GetQuestion())).GetAnswer2((IncidentalLearningViewB) findViewById(R.id.incidental_learning2));
        }
        switch (v.getId())
        {
            case R.id.incidental_learningGetNext:
                ...
                intent.setClass(IncidentalLearningActivity.this, mQuestionItemSet.GetActivity());
            ...
            case R.id.btnFINISH:
                ...
                intent2.setClass(IncidentalLearningActivity.this, EndActivity.class);
            ...
            case R.id.btnBACK:
                ...
                intent3.setClass(IncidentalLearningActivity.this, Content2.class);
