...
public class BalanceActivity extends Activity implements OnClickListener
{
    ...
    private void InitView()
    {
        ...
        balanceQuestion = (BalanceQuestion) ((mQuestionItemSet.GetQuestion()));
        BalanceView balance = (BalanceView) findViewById(R.id.balance);///////////
        balance.Init(balanceQuestion, helper);
        Button btn = (Button) findViewById(R.id.balanceGetNext);
    ...
    public void onClick(View v)
    {
        ...
        {
            balanceQuestion.skip = true;
            for (int i = 0; i < balanceQuestion.skipQues.size(); ++i)
                mQuestionItemSet.questionItemSet.get(balanceQuestion.skipQues.get(i)).skip = true;
        } else
            balanceQuestion.skip = false;
        ((BalanceQuestion) (mQuestionItemSet.GetQuestion())).GetAnswer((BalanceView) findViewById(R.id.balance));

        switch (v.getId())
        {
            case R.id.balanceGetNext:
                Helper helper = new Helper();
                helper.ossService = OSSServiceProvider.getService();
                helper.ossService.setApplicationContext(getApplicationContext());
                helper.Init();
                ...
                intent.setClass(BalanceActivity.this, mQuestionItemSet.GetActivity());
            ...
            case R.id.btnFINISH:
                ...
                intent2.setClass(BalanceActivity.this, EndActivity.class);
            ...
            case R.id.btnBACK:
                ...
                intent3.setClass(BalanceActivity.this, Content2.class);
