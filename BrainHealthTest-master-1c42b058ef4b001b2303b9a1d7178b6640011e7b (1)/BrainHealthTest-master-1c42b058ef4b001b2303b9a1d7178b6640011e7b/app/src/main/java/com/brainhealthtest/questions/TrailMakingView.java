...
public class TrailMakingView extends LinearLayout
{
    Context mContext;
    TextView view1_1, view1_2, view1_3, view1_4, view1_5, view1_6, view2_1, view2_2, view2_3, view2_4, view2_5, view2_6, view2_7, view2_8, view2_9, view3_1, view3_2, view3_3, view3_4;
    Button button1_0, button1_1, button2_0, button2_1, button3_0, button3_1;
    public EditText txt1, txt2, txt3, txt4, txt5, txt6, txt7, txt8, txt9;
    public Handler callbackHandler;
    public int score1 = -1, score2_1 = -1, score2_2 = -1;

    public TrailMakingView(final Context context, final AttributeSet attrSet)
    {
    ...
    public TrailMakingView(Context context)
    {
        super(context);
        // TODO Auto-generated constructor stub
    }

    public TrailMakingView(final Context context, final TrailMakingQuestion trailmakingQuestion, Handler handler)
    {
        super(context);
    ...
    public void Init(TrailMakingQuestion trailQuestion, Helper helper)
    {
        ...
        view2_3.setText("Other");
        view2_3.setWidth(149);
        ...
        view2_5.setText("Other");
        view2_5.setWidth(149);
