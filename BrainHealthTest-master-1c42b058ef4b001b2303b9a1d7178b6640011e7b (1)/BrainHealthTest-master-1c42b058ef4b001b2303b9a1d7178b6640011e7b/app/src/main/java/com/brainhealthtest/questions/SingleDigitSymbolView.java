...
public class SingleDigitSymbolView extends LinearLayout
{
    ...
    public SingleDigitSymbolView(Context context)
    {
        super(context);
    ...
    public SingleDigitSymbolView(final Context context, final AttributeSet attrSet)
    {
        super(context, attrSet);
        instantiate(context, null);
    }

    public SingleDigitSymbolView(final Context context, final String imageUrl, Handler handler)
    {
        super(context);
